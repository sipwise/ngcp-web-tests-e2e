...
Cypress.Commands.add('loginUI', (username, password, waitForSidemenu = true) => {
    ...
    cy.get('[data-cy=aui-input-username]', quiet).type(username, quiet)
    cy.get('[data-cy=aui-input-password]', quiet).type(password, quiet)
...
Cypress.Commands.add('logoutUI', () => {
    ...
    cy.get('[data-cy=q-toolbar] [data-cy=usermenu-btn]', quiet).click(quiet)
