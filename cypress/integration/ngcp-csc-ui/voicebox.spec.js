...
context('Voicebox page tests', () => {
    context('UI Voicebox tests', () => {
        ...
        it('Switch between all Voicebox languages', () => {
            ...
            cy.get('label[data-cy="voicebox-change-pin"][aria-disabled="true"]').should('not.exist')
        ...
        it('Change and Undo PIN', () => {
            ...
            cy.get('label[data-cy="voicebox-change-pin"][aria-disabled="true"]').should('not.exist')
            cy.get('input[data-cy="voicebox-change-pin"]').clear().type('1234')
        ...
        it('Change and Undo Email', () => {
            ...
            cy.get('label[data-cy="voicebox-change-email"][aria-disabled="true"]').should('not.exist')
        ...
        it('Upload/Delete busy greeting sound', () => {
            ...
            cy.get('div[data-cy="voicebox-attach-file"] [aria-disabled="true"]').should('not.exist')
            cy.get('div[data-cy="voicebox-busy-greeting"] input[type="file"]').focus().selectFile(path.join(fixturesFolder, 'ring.wav'), { force: true })
