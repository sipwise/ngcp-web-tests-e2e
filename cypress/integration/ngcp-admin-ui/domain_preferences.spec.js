...
context('Domain preferences tests', () => {
    context('UI domain preferences tests', () => {
        ...
        it('Test all Internal settings in domain', () => {
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('default_lnp_prefix')
            cy.get('div[data-cy="q-item--contact-ringtimeout"]').should('not.exist')
            testPreferencesTextField('default_lnp_prefix')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('disable_prack_method')
            cy.get('div[data-cy="q-item--default-lnp-prefix"]').should('not.exist')
            testPreferencesToggleField('disable_prack_method')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('emergency_mode_enabled')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('la')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('lcr_peer_cf')
            cy.get('div[data-cy="q-item--last-number-redial"]').should('not.exist')
            testPreferencesToggleField('lcr_peer_cf')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('lnp_')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('lookup_all_registrations')
            cy.get('div[data-cy="q-item--lnp-to-rn"]').should('not.exist')
            testPreferencesToggleField('lookup_all_registrations')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('mobile_push')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('re')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('ua')
        ...
        it('Test all Media Codec Transcoding Options settings in domain', () => {
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('AMR')
            cy.wait(2)
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('ptime')
            cy.get('div[data-cy="q-item--opus-stereo-bitrate"]').should('not.exist')
            testPreferencesListField('ptime', '60 ms')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('T38')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('transcode')
        ...
        it('Test all Number Manipulations settings in domain', () => {
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('outbound')
            ...
            testPreferencesToggleField('outbound_from_user_is_phone')
            cy.get('label[data-cy="aui-input-search"] input').clear().type('rewrite_rule_set')
            ...
            cy.get('label[data-cy="aui-input-search"] input').clear().type('skip_upn_check_on_diversion')
